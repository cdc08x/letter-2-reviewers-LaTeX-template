...
\author[1]{Claudio~{Di~Ciccio}%
  \thanks{Corresponding author \\
    {\Letter}~{Sapienza Università di Roma, Viale Regina Elena 295, 00161 Rome, Italy} \\
    {\Email}~\texttt{\href{mailto:claudio.diciccio@uniroma1.it}{claudio.diciccio@uniroma1.it}} \\
    {\Telefon}~\textsf{+39 123 456 7890}%
  }
}
%
\author[2]{Author Ecs}
